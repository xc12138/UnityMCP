...
**Required:** Install the [Unity MCP Plugin](https://github.com/xc12138/UnityMCP?tab=readme-ov-file#-step-1-install-the-unity-package) to connect Unity Editor with this MCP server.
...
For full details, see the [Remote Server Auth Guide](https://github.com/xc12138/UnityMCP/blob/main/docs/guides/REMOTE_SERVER_AUTH.md).
