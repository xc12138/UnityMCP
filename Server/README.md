...
**Required:** Install the [Unity MCP Plugin](https://github.com/xc12138/UnityMCP?tab=readme-ov-file#-step-1-install-the-unity-package) to connect Unity Editor with this MCP server. You also need `uvx` (requires [uv](https://docs.astral.sh/uv/)) to run the server.
...
```json
{
  "mcpServers": {
    "UnityMCP": {
      ...
      "args": [
        "--from",
        "git+https://github.com/xc12138/UnityMCP@v9.6.0#subdirectory=Server",
        "mcp-for-unity",
        "--transport",
        "stdio"
      ]
...
git clone https://github.com/xc12138/UnityMCP.git
cd unity-mcp/Server
...
📖 **[Full Documentation](https://github.com/xc12138/UnityMCP#readme)**
...
MIT License - See [LICENSE](https://github.com/xc12138/UnityMCP/blob/main/LICENSE)
