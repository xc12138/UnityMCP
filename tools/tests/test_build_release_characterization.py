...
Install from git:
```bash
pip install git+https://github.com/xc12138/UnityMCP@v9.2.0#subdirectory=Server
```

Or via package URL:
```
https://github.com/xc12138/UnityMCP.git?path=/MCPForUnity#v9.2.0
```
'''
...
class TestVersionBumpingLogic:
    ...
    def test_update_readme_git_url_with_version(self, temp_repo, sample_readme_content):
        ...
        Pattern:
        FROM: git+https://github.com/xc12138/UnityMCP@v9.2.0#subdirectory=Server
        TO:   git+https://github.com/xc12138/UnityMCP@v9.3.0#subdirectory=Server
        """
        ...
        replacement = f'git+https://github.com/xc12138/UnityMCP@v{new_version}#subdirectory=Server'
    ...
    def test_update_readme_package_url_with_version(self, temp_repo, sample_readme_content):
        ...
        Pattern:
        FROM: https://github.com/xc12138/UnityMCP.git?path=/MCPForUnity#v9.2.0
        TO:   https://github.com/xc12138/UnityMCP.git?path=/MCPForUnity#v9.3.0
        """
        ...
        replacement = f'https://github.com/xc12138/UnityMCP.git?path=/MCPForUnity#v{new_version}'
